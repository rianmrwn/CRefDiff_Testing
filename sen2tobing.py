...
class BingMapDownloader:
    def __init__(self, api_key=None):
        ...
        self.tile_size = 256  # 256x256 tiles as per your QGIS settings
        self.max_retries = 3
    ...
    def calculate_zoom_from_resolution(self, target_resolution_meters, latitude):
        ...
        # Cap at maximum available zoom (22 is the highest available in Bing Maps)
        zoom_level = min(22, max(1, zoom_level))
    ...
    def get_tile_url(self, quadkey):
        """Generate URL for a tile based on its quadkey"""
        # Using the exact URL format from your QGIS settings
        return f"https://ecn.t3.tiles.virtualearth.net/tiles/a{quadkey}.jpeg?g=0&dir=dir_n"
